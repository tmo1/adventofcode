...
for line in sys.stdin:
    ...
    ingredients.append([int(words[2]), int(words[4]), int(words[6]), int(words[8])])
high_score = 0


def add_ingredient(spoons, partial_scores, i):
    global high_score
    ...
    if i == len(ingredients) - 1:
        ...
        for j in range(101 - spoons):
            ...
            add_ingredient(spoons + j, new_partial_scores, i + 1)


add_ingredient(0, [0, 0, 0, 0], 0)
print(high_score)
